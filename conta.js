...
// Fecha o modal ao clicar no fundo (fora do modal)
document.getElementById("fundo").addEventListener("click", function() {
    fecharModal();
});

// Evita que o clique dentro do modal feche o modal
document.getElementById("modal").addEventListener("click", function(event) {
    event.stopPropagation(); // Impede a propagação do clique para o fundo
});
